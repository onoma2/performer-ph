# CLAUDE.md - AI Assistant Guide for PEW|FORMER

## Project Overview

**PEW|FORMER** is firmware for an 8-track Eurorack sequencer module, originally created by westlicht and now maintained with improvements from the community. This is a professional embedded systems project combining real-time sequencer logic on STM32 hardware with cross-platform simulation capabilities.
